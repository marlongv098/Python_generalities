...
infile = open(argv[1], 'r')		# THIS CHUNK OF PROGRAM OPEN AND READ THE FILE 
text = infile.read()
infile.close()
...
outfile = open('alice_counts_argv.dat', 'w')			# THIS CHUNK PRINT THE HEAD OF THE OUTFILE "alice_counts.dat"
outfile.write("%-12s%s\n" % ("Character", "Count"))
outfile.write("=================\n")
